...
namespace WinForms
{
    public partial class RankingListEntry : UserControl, IComparable<RankingListEntry>
    {
        ...
        public RankingListEntry(Settings settings, Player player)
        {
        ...
        public int CompareTo(RankingListEntry? other)
        {
